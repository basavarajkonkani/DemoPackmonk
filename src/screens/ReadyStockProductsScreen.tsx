...
const READY_STOCK_PRODUCTS: ReadyStockProduct[] = [
  {
    ...
    ecoRating: 3,
    sizeOptions: [
      { id: 'size1', dimensions: '10.5 × 17 × 3 cm', capacity: 'GSP1 - 100 g', price: 2.45 },
      { id: 'size2', dimensions: '13.5 × 20.5 × 3.5 cm', capacity: 'GSP2 - 250 g', price: 3.85 },
      { id: 'size3', dimensions: '15 × 20.5 × 3.5 cm', capacity: 'GSP3 - 500 g', price: 4.25 },
      { id: 'size4', dimensions: '18 × 25 × 4 cm', capacity: 'GSP4 - 1000 g', price: 6.15 },
    ],
  },
  {
    id: 'rs002',
    ...
    ecoRating: 3,
    sizeOptions: [
      { id: 'size1', dimensions: '10.5 × 17 × 3 cm', capacity: 'GSZP1 - 100 g', price: 3.15 },
      { id: 'size2', dimensions: '13.5 × 22 × 3.5 cm', capacity: 'GSZP2 - 250 g', price: 5.15 },
      { id: 'size3', dimensions: '16 × 23 × 3.5 cm', capacity: 'GSZP3 - 500 g', price: 6.25 },
      { id: 'size4', dimensions: '17 × 26.5 × 4 cm', capacity: 'GSZP4 - 1000 g', price: 7.60 },
    ],
  },
  {
    id: 'rs003',
    ...
    ecoRating: 3,
    sizeOptions: [
      { id: 'size1', dimensions: '8.5 × 13.5 × 2.5 cm', capacity: 'SSP1 - 50 g', price: 1.35 },
      { id: 'size2', dimensions: '10.5 × 17 × 3 cm', capacity: 'SSP2 - 100 g', price: 2.10 },
      { id: 'size3', dimensions: '10.5 × 20.5 × 3.5 cm', capacity: 'SSP3 - 200 g', price: 2.50 },
      { id: 'size4', dimensions: '13.5 × 20.5 × 3.5 cm', capacity: 'SSP4 - 250 g', price: 3.20 },
      { id: 'size5', dimensions: '15 × 20.5 × 3.5 cm', capacity: 'SSP5 - 500 g', price: 3.60 },
      { id: 'size6', dimensions: '18 × 25 × 4 cm', capacity: 'SSP6 - 1000 g', price: 5.25 },
  ...
  },
  {
    ...
    ecoRating: 3,
    sizeOptions: [
      { id: 'size1', dimensions: '10 × 13.5 × 2.5 cm', capacity: 'SZSZP1 - 50 g', price: 2.10 },
      { id: 'size2', dimensions: '10 × 17 × 3.5 cm', capacity: 'SZSZP2 - 100 g', price: 2.55 },
      { id: 'size3', dimensions: '10.5 × 21 × 3.5 cm', capacity: 'SZSZP3 - 200 g', price: 3.05 },
      { id: 'size4', dimensions: '13.5 × 22 × 3.5 cm', capacity: 'SZSZP4 - 250 g', price: 4.15 },
      { id: 'size5', dimensions: '16 × 23 × 3.5 cm', capacity: 'SZSZP5 - 500 g', price: 5.00 },
      { id: 'size6', dimensions: '17 × 26.5 × 4 cm', capacity: 'SZSZP6 - 1000 g', price: 6.05 },
      { id: 'size7', dimensions: '20 × 30 × 5 cm', capacity: 'SZSZP7 - 2000 g', price: 8.10 },
    ],
  },
  {
    id: 'rs005',
    ...
    ecoRating: 4,
    sizeOptions: [
      { id: 'size1', dimensions: '10.5 × 17 × 3 cm', capacity: 'MSP1 - 100 g', price: 2.10 },
      { id: 'size2', dimensions: '13.5 × 20.5 × 3.5 cm', capacity: 'MSP2 - 250 g', price: 3.25 },
      { id: 'size3', dimensions: '15 × 20.5 × 3.5 cm', capacity: 'MSP3 - 500 g', price: 3.60 },
      { id: 'size4', dimensions: '18 × 25 × 4 cm', capacity: 'MSP4 - 1000 g', price: 5.25 },
    ],
  },
  {
    id: 'rs006',
    ...
    ecoRating: 4,
    sizeOptions: [
      { id: 'size1', dimensions: '10 × 17 × 3.5 cm', capacity: 'MSZP1 - 100 g', price: 2.55 },
      { id: 'size2', dimensions: '13.5 × 22 × 3.5 cm', capacity: 'MSZP2 - 250 g', price: 4.15 },
      { id: 'size3', dimensions: '16 × 23 × 3.5 cm', capacity: 'MSZP3 - 500 g', price: 5.00 },
      { id: 'size4', dimensions: '17 × 26.5 × 4 cm', capacity: 'MSZP4 - 1000 g', price: 6.05 },
    ],
  },
  {
    id: 'rs007',
  ...
  },
  {
    ...
    ecoRating: 5,
    sizeOptions: [
      { id: 'size1', dimensions: '10 × 15 × 3 cm', capacity: 'KWSP1 - 50 g', price: 4.25 },
      { id: 'size2', dimensions: '12 × 20 × 4 cm', capacity: 'KWSP2 - 100 g', price: 5.42 },
      { id: 'size3', dimensions: '14 × 20 × 4 cm', capacity: 'KWSP3 - 250 g', price: 5.75 },
      { id: 'size4', dimensions: '16 × 22 × 4 cm', capacity: 'KWSP4 - 500 g', price: 7.16 },
      { id: 'size5', dimensions: '18 × 26 × 4 cm', capacity: 'KWSP5 - 1000 g', price: 8.83 },
      { id: 'size6', dimensions: '20 × 30 × 5 cm', capacity: 'KWSP6 - 2000 g', price: 11.58 },
      { id: 'size7', dimensions: '30 × 40 × 6 cm', capacity: 'KWSP7 - 3000 g', price: 22.66 },
    ],
  },
  {
    id: 'rs009',
    ...
    ecoRating: 5,
    sizeOptions: [
      { id: 'size1', dimensions: '12 × 20 × 4 cm', capacity: 'KWSP1 - 100 g', price: 6.41 },
      { id: 'size2', dimensions: '14 × 20 × 4 cm', capacity: 'KWSP2 - 250 g', price: 7.50 },
      { id: 'size3', dimensions: '15 × 22 × 4 cm', capacity: 'KWSP3 - 500 g', price: 8.50 },
      { id: 'size4', dimensions: '18 × 26 × 4 cm', capacity: 'KWSP4 - 1000 g', price: 10.80 },
    ],
  },
];
