...
const SavedDesignsScreen: React.FC = () => {
  ...
  const designs: SavedDesign[] = [
    {
      id: '1',
      name: 'Coffee Pouch Design',
      productType: 'Stand-Up Pouch',
      thumbnail: IMAGES.kraftPouch,
    ...
    },
    {
      id: '2',
      name: 'Tea Packaging',
      productType: 'Center Seal Pouch',
      thumbnail: IMAGES.plainPouch,
    ...
    },
    {
      ...
      productType: 'Printed Stand-Up Pouch',
      thumbnail: IMAGES.standupPouch,
    ...
    {
      id: '4',
      name: 'Batter Pouch Design',
      productType: 'Custom Printed Pouch',
      thumbnail: IMAGES.batterPouch,
